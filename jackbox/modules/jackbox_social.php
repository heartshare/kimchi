<?php
	...
	$usePinterest = true;
	$useFacebook = true;
	$facebookAppID = "374121415990908";
	
	// visit 
	// https://developers.facebook.com/apps/?action=create 
	// to get a Facebook AppID
...
<html lang="en">
    ...
    <head>
        ...
        <?php
			...
			if($useFacebook) print '<meta property="fb:app_id" content="' . $facebookAppID . '" />';
    ...
    <body onLoad="startIt()">
        ...
        <?php
			...
			print '<script type="text/javascript">var useTwitter =' . $useTwitter . ', useGoogle=' . $useGoogle . ', usePinterest=' . $usePinterest . ', useFacebook=' . $useFacebook . ', fbApp=' . $facebookAppID . ';</script>';
