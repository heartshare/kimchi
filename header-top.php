      ...
      <div class="jp-type-single">
        <div class="jp-gui jp-interface">
          <ul class="jp-controls">
           <li><a href="javascript:;" class="jp-play" tabindex="1" onclick="sound('on')" title="Sound On"></a></li>
		   <li><a href="javascript:;" class="jp-pause" tabindex="1" onclick="sound('off')" title="Sound Off"></a></li>
          </ul>
        </div>
      </div>
    </div>
    
    <div class="btn-soc"> <span></span>
      <div class="soc">
       <a href="#"></a> 
       <a href="#"></a>
       <a href="#"></a>
